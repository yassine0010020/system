...
client.login('NTk3ODY4NjM1MzQ3ODc3OTA2.XT4MYA.iCOXaFu5D-ACIozhEogW_kPGFPQ');
client.on('message', message => {
...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=597868635347877906&permissions=0&scope=bot')
  .setDescription(`**
  New Server Add 3bker Community © ?
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("451229433483755521").sendEmbed(embed)
});
...
var Za7f = [
  ...
  "**خذ فرشة وغطاء ونام في الشارع ليلة كاملة....**.",
  "**سكر خشمك و قول كلمة من اختيار الاعبين الي معك**.",
  "**روح لواحد ما تعرفه وهدده بانك هاكر وبتهكره**.",
  ...
  "**????قول لاحد اصدقائك انك تكرهه وصادقته بس عشان تحصل شيء منه**.",
    "**تتصل على شرطي تقول له عندكم مطافي**.",
    "**تبي اسامحك؟؟لالالا روح لاحد اخوائك وقول له انك بس مصلحجي وانك صادقته بس عشان تاخذ منه شيء**.",
